...
def parseJson(path):
    for file in os.listdir(path):
        ...
        if file.endswith(".json"):
            ...
            with codecs.open(f_json, "r", "utf-8") as f, codecs.open(
                f_text, "w", "utf-8"
            ) as w1, codecs.open(f_ann, "w", "utf-8") as w2:
                jsonObj = json.load(f)
                            ...
                            if "Relation" in j:
                                ...
                                for relationitem in j["Relation"]:
                                    ...
                                    if "%d_%d" % (frombegin, fromend) not in entitylst:
                                        ...
                                        fromindex = entitylst.get(
                                            "%d_%d" % (frombegin, fromend)
                                        ).index
                                    ...
                                    if "%d_%d" % (tobegin, toend) not in entitylst:
                                        ...
                                        toindex = entitylst.get(
                                            "%d_%d" % (tobegin, toend)
                                        ).index

                                    relation = Relation(
                                        reindex,
                                        relationitem["semantic"],
                                        fromindex,
                                        toindex,
                                    )
...
if __name__ == "__main__":
    path = r"/Users/xzuo/Downloads/Task122"
    parseJson(path)
