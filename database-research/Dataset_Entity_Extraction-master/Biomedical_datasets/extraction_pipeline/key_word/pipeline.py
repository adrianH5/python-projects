...
folder_path = "/home/gy237/project/Biomedical_datasets/extraction_pipeline/sampled_id_list/recoed_id_list/gui"
path2 = "/home/gy237/project/Biomedical_datasets/extraction_pipeline/sampled_id_list/recoed_id_list/Kalpana"
...
for name in all_items:
    ...
    # download the files
    # os.makedirs(f'/home/gy237/project/Biomedical_datasets/extraction_pipeline/key_word/{name}', exist_ok=True)

    # for pmcid in pmcids:
    #     os.system(f'''wget -c -O /home/gy237/project/Biomedical_datasets/extraction_pipeline/key_word/{name}/{pmcid}.json https://www.ncbi.nlm.nih.gov/research/bionlp/RESTful/pmcoa.cgi/BioC_json/{pmcid}/unicode''')
    papers_dic = []
    papers = []
    corpus = []
    for pmcid in pmcids:
