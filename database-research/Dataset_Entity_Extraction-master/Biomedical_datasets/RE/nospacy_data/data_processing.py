...
_type = "devel"
files = os.listdir(f"/home/gy237/project/Biomedical_datasets/data/{_type}_data")
print(len(files))
...
for _id in data_id:
    ...
    entities, relations = parse_ann_file(
        f"/home/gy237/project/Biomedical_datasets/data/{_type}_data/{_id}.ann"
    )

    with open(
        f"/home/gy237/project/Biomedical_datasets/data/{_type}_data/{_id}.txt",
        "r",
        encoding="utf-8",
    ) as f:
        text = f.read()
    ...
    for _ent in entities:
        if _ent["name"] != text[_ent["start"] : _ent["end"]]:
            print(_id, "wwadad")  # PMC7366180, PMC7441778
    for i in relations:
...
# with open(f'/home/gy237/project/Biomedical_datasets/RE/nospacy_data/{_type}_data.json', 'w', encoding='utf-8') as file:
